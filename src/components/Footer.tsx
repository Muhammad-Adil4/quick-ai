...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 mt-35 xl:px-32 pt-8 w-full text-gray-500">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
          <Image className="h-9" src={assets.logo} alt="dummyLogoDark" />
      ...
      <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2024 © <a href="https://prebuiltui.com">Aadi_86</a>. All
        Right Reserved.
      </p>
    </footer>
  );
