  ...
  return (
    <section className="px-4 sm:px-20 xl:px-32 py-24">
      ...
      <div className="text-center">
        <h2 className="text-slate-700 text-[32px] sm:text-[42px] font-semibold">
          Loved by Creators
        </h2>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
        {dummyTestimonialData.map((testimonial, index) => (
          <article
            key={index}
            className="p-8 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer"
          >
            {/* Rating Stars */}
            <div
